        ...
        sidebarLayout(
          ...
          mainPanel(width=10,
                    ...
                    fluidRow(
                      ...
                      column(width=3, selectizeInput("parameters_to_process2",label ="Select parameters to process",
                                                        choices=c('v1','v2'),
                                                        multiple = TRUE,
                                                        options = list(hideSelected = FALSE,plugins=list('remove_button'))
                      )),
  ...
  output$display_dateFormat <- renderUI({
    selectizeInput(
      ...
      choices = c(c('Year,Month,Day'),c('Year,Day,Month'),c('Month,Day,Year'),
                  c('Day,Month,Year'),c('Year,Month,Day Hour,Minute,Second'),
                  c('Month,Day,Year Hour,Minute'),c('Abbreviated month,Day of the month,Year')),
      multiple = FALSE,
      options = list(
        hideSelected = FALSE,
        plugins = list('remove_button')
